...
export type { Email, EmailAddress, EmailAttachment, EmailPriority, EmailAction, EmailClassification, ClassifiedEmail, EmailAgentConfig, } from './types.js';
export type { EmailAgentResult, EmailProgressEvent, ProgressCallback, EmailSaveCallback } from './email-agent.js';
