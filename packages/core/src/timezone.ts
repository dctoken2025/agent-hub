 ...
 */
export function formatDateBrazil(date: Date | string, options?: Intl.DateTimeFormatOptions): string {
 ...
 */
export function formatDateOnlyBrazil(date: Date | string): string {
  const d = typeof date === 'string' ? new Date(date) : date;
 ...
 */
export function toStartOfDayBrazil(date: Date | string): Date {
 ...
 */
export function minutesAgoBrazil(date: Date | string): number {
  const d = typeof date === 'string' ? new Date(date) : date;
  const now = new Date();
 ...
 */
export function formatRelativeBrazil(date: Date | string): string {
  const d = typeof date === 'string' ? new Date(date) : date;
  const now = new Date();
